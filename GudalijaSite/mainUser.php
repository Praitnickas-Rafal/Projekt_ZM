...
if (!isset($_SESSION['username'])) {
  // Użytkownik nie jest zalogowany, przekieruj na stronę logowania lub gdziekolwiek indziej
  header("Location: /GudalijaSite/SystemLogowanie/sign-in.php");
  exit();
}

// Pobierz imię użytkownika z sesji
  ...
  <body>
    ...
    <nav>
      <div class="section__container nav__links">
        ...
        <p>Jest zalogowany: <?php echo $username; ?></p>

<form method="post" action="/GudalijaSite/SystemLogowanie/server.php?logout=1">
...
?>
    ...
    <form action="comment.php" method="post">
        ...
        <br>
        <textarea name="comment" rows="4" cols="50" maxlength="150"></textarea>
        <br>
